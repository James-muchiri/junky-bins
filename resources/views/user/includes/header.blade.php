        ...
        <div class="row align-items-center full_size header_v">
            ...
            <div class="col-lg-9">
                ...
                <!-- <li><a href="{{ url('/home') }}"><span class="d-none d-sm-block d-sm-none "><i class="fa fa-home"></i></span><span class="d-lg-none d-xl-none d-md-none">Home</span> </a></li> -->
                    ...
                    <li class="drop" >
                                            <a class="" href="{{ url('/') }}">Our Services</a>
                    ...
                    <li><a class="" href="{{ url('/coming-soon') }}">Pricing</a></li>
                    <li><a class="" href="{{ url('/coming-soon') }}">About Us</a></li>
                    <li><a class="" href="{{ url('/coming-soon') }}">Contact us</a></li>
