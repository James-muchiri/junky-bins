                        ...
                        <div class="row blog-style-one">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                <div class="sr-blog-thumb-section">
                                        ...
                                        <a class="sr-blog-img" href="/admin/previewblogbyid/{{$blog['id']}} ">
                                            ...
                                            <span class="sr-blog-date">
                                                ...
                                                <div class="sr-blog-data">
                                                    ...
                                                    <a class="sr-blog-authore" href="/admin/previewblogbyid/{{$blog['id']}} ">
                                                    ...
                                                    <a href="/admin/previewblogbyid/{{$blog['id']}} "> {{$blog['comments_count']}}   Comments                    					    </a>
                                                    </li>
                                                </ul>
                                            </div>
                                            <a  href="/admin/previewblogbyid/{{$blog['id']}} ">
                                                <h4 class="sr-blog-title">
                                                    {{$blog['bloginfo']}}                                  </h4>
                                            </a>
                                            <p>  {{$blog['blog_description']}} </p>
                                            <a  href="/admin/previewblogbyid/{{$blog['id']}} " class="sr-read-more-link">
